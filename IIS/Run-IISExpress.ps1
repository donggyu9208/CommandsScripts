...
& "C:\Program Files\IIS Express\iisexpress.exe" "/config:C:\Users\donglee\source\repos\RBUpdatePods\RBUpdatePods\bin\Debug\netcoreapp2.2\publish\applicationhost.config"